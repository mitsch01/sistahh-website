...
export default function Page() {
  return (
    <div>
      <div className='flex flex-col justify-center max-w-screen-sm mx-auto pt-24 px-8'>
        <h1 className='text-4xl mb-12 font-bold text-center bg-heading-gradient bg-clip-text text-transparent'>Contact</h1>
